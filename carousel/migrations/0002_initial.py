...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'carousel_carouselitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('carousel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['carousel.Carousel'])),
        ...
        db.send_create_signal(u'carousel', ['CarouselItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'carousel_carouselitem')
    ...
    models = {
        ...
        u'carousel.carouselitem': {
            ...
            'carousel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['carousel.Carousel']"}),
